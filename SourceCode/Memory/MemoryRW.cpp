	...
	while(true)
	{
		...
		switch(select)
		{
			case 1: cout<<endl;
				...
				cout<<"Latency is : "<<(((double)(endTime-startTime)/CLOCKS_PER_SEC)/(5ul*1024ul*1024ul*1024ul))*1000ul<<"ms"<<endl;
                ...
                endTime=clock();
				cout<<"Time for 1Byte block : "<<(double)(endTime-startTime)/CLOCKS_PER_SEC<<endl;
				...
				pthread_join(thread2,NULL);
                endTime=clock();
                cout<<"Time for 1KB block : "<<(double)(endTime-startTime)/CLOCKS_PER_SEC<<endl;
				...
				pthread_join(thread2,NULL);
                endTime=clock();
                cout<<"Time for 1MB block : "<<(double)(endTime-startTime)/CLOCKS_PER_SEC<<endl;
                ...
                endTime=clock();
                cout<<"Time for 1Byte block : "<<(double)(endTime-startTime)/CLOCKS_PER_SEC<<endl;
				cout<<"Latency is : "<<(((double)(endTime-startTime)/CLOCKS_PER_SEC)/(20ul*1024ul*1024ul))<<"ms"<<endl;
